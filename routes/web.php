...
Route::group(['prefix'=>'dashboard','middleware'=>'auth'],function (){
    ...
    Route::group(['prefix'=>'settings'],function (){
        ...
        Route::group(['prefix'=>'cars_type'],function (){
            ...
            Route::post('change_status',[App\Http\Controllers\dashboard\admin\settings\CarsTypeController::class , 'change_status'])->name('dashboard.settings.cars_type.change_status');
        });
        Route::group(['prefix'=>'terms_of_use'],function (){
...
Route::group(['prefix'=>'web_pages'],function (){
    Route::get('/about_us', [App\Http\Controllers\web_page\PagesController::class, 'about_us'])->name('web_pages.about_us');
    Route::get('/contact_us', [App\Http\Controllers\web_page\PagesController::class, 'contact_us'])->name('web_pages.contact_us');
    Route::post('/post_suggestion', [App\Http\Controllers\web_page\PagesController::class, 'post_suggestion'])->name('web_pages.post_suggestion');
    Route::group(['prefix' => 'part_expo'], function () {
        Route::get('/index', [App\Http\Controllers\web_page\PartExpoController::class, 'index'])->name('web_pages.part_expo.index');
        Route::get('/details/{id}', [App\Http\Controllers\web_page\PartExpoController::class, 'details'])->name('web_pages.part_expo.details');
        Route::get('/add', [App\Http\Controllers\web_page\PartExpoController::class, 'add'])->name('web_pages.part_expo.add');
        Route::post('/delete', [App\Http\Controllers\web_page\PartExpoController::class, 'delete'])->name('web_pages.part_expo.delete');
        Route::post('/search', [App\Http\Controllers\web_page\PartExpoController::class, 'search'])->name('web_pages.part_expo.search');
        Route::get('/get_models/{id}', [App\Http\Controllers\web_page\PartExpoController::class, 'get_models'])->name('web_pages.part_expo.get_models');
