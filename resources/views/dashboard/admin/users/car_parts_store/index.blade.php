...
@section('content')
    <div class="row">
        <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">قائمة محلات قطع السيارات</h3>
                    </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        @foreach($data as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="{{ route('dashboard.users.car_part_store.edit',['id'=>$key->id]) }}"><span class="fa fa-edit"></span></a>
                                                    <a class="btn btn-dark btn-sm" href="{{ route('dashboard.users.car_part_store.details',['id'=>$key->id]) }}"><span class="fa fa-search"></span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
        ...
        <div class="col-md-2">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('dashboard.users.car_part_store.add') }}" class="btn form-control btn-dark mb-2">اضافة محل قطع سيارات</a>
