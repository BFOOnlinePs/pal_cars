...
<div class="row">
    ...
    <div class="card">
        <div class="card-body">
            <h3 class="text-center"> الإعلان عن سيارة في الموقع</h3>
            <h6 class="text-center"> لعرض السيارة الرجاء اختيار نوع السيارة</h6>
            <br>
            {{-- <div class="row justify-content-center">
                @foreach ($cars as $car)
                <div class="card col-lg-2 col-md-3 col-sm-4 col-6">
                    <br>
                    <a href="{{ auth()->check() ? route('web_pages.cars_ads.add', ['id' => $car->id,'user_id'=>auth()->user()->id]) : route('login') }}">
