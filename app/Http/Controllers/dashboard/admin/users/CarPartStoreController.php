...
class CarPartStoreController extends Controller
{
    public function index()
    {
        $data = User::whereJsonContains('user_role', ['13'])->get();
        return view('dashboard.admin.users.car_parts_store.index', ['data' => $data]);
    }
